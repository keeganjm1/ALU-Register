...
("ALU OR test",
        TestCase(os.path.join(file_locations,'alu-or.circ'),
                 [[0, 0, 0, 0xFFFFFFFF],
                  ...
                  [4, 0, 0, 0xDDDDDDDD],
                  [5, 0, 0, 0xD4777753],
                  [6, 0, 1, 0x00000000]]), "alu"),
("ALU SLTSLTU test",
        TestCase(os.path.join(file_locations,'alu-sltsltu.circ'),
                 [[0, 0, 0, 0x00000001],
                  [1, 0, 0, 0x00000001],
                  [2, 0, 0, 0x00000000],
                  [3, 0, 1, 0x00000000],
...
("ALU XOR test",
  ...
  ("RegFile self test",
        TestCase(os.path.join(file_locations,'regfile-self.circ'),
                [[0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0],
                 [1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0],
                 [2, 0x0, 0x0, 0x0,0x0, 0x0, 0x0, 0x0],
                 [3, 0x0, 0x0, 0x0, 0xFFFFFFFF, 0x0, 0x0, 0x0],
                 [4, 0x0, 0x0, 0x0, 0xFFFFFFFF, 0x0, 0x0, 0x0]]), "regfile")
]
